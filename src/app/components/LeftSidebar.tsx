    ...
    <section className="sticky top-0 w-full flex flex-col items-stretch h-screen">
      <div className="flex flex-col items-stretch h-full space-y-4 mt-4">
        {NAVIGATION_ITEMS.map((item) => (
          <Link
            className="hover:bg-white/30 text-2xl transition duration-200 flex items-center justify-start w-fit space-x-2 rounded-3xl py-2 px-6"
        ...
        <button className="rounded-full m-4 bg-primary p-4 text-center hover:bg-opacity-70 transition duration-200">
          Tweet
        </button>
      </div>
